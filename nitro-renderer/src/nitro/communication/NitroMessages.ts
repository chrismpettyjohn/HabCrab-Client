...
import {
  ...
  TrackerListEvent,
  TrackerDataEvent,
  QuestGetByIdComposer,
  QuestGetAllComposer,
  QuestDeleteComposer,
  QuestUpdateComposer,
  QuestCreateComposer,
  TrackerGetAllComposer,
...
export class NitroMessages implements IMessageConfiguration {
  ...
  private registerEvents(): void {
    ...
    // Crab
    this._events.set(IncomingHeader.QUEST_LIST, QuestListEvent);
  ...
  private registerComposers(): void {
    ...
    // Crab
    this._composers.set(OutgoingHeader.QUEST_CREATE, QuestCreateComposer);
    this._composers.set(OutgoingHeader.QUEST_UPDATE, QuestUpdateComposer);
    ...
    this._composers.set(OutgoingHeader.TRACKER_DELETE, TrackerDeleteComposer);
    this._composers.set(OutgoingHeader.TRACKER_GET_ALL, TrackerGetAllComposer);
    this._composers.set(OutgoingHeader.TRACKER_GET_BY_ID, TrackerGetByIdComposer);
  }
